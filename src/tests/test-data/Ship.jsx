export const ShipTest = {
  symbol: "VITESTER-1",
  nav: {
    systemSymbol: "X1-UF75",
    waypointSymbol: "X1-UF75-A1",
    route: {
      departure: {
        symbol: "X1-UF75-A1",
        type: "PLANET",
      ...
      arrival: "2024-01-10T08:36:43.957Z",
      departureTime: "2024-01-10T08:36:43.957Z",
    },
    status: "DOCKED",
    flightMode: "CRUISE",
  },
  ...
  fuel: {
    ...
    consumed: {
      amount: 0,
      timestamp: "2024-01-10T08:36:43.957Z",
    },
  },
  cooldown: {
    shipSymbol: "VITESTER-1",
    totalSeconds: 0,
    remainingSeconds: 0,
  },
  frame: {
